  ...
  <div id="BusinessData">
    <el-card style="margin-bottom:25px">
      ...
      <el-form :model="inputFrom" :rules="rules" ref="inputFrom" id="inputForm">
        ...
        <el-col :span="10">
          <el-form-item label="关键字(输入企业名称或工商注册号，统一社会信用代码)" label-width="0" prop="idCard" class="form-item">
...
<el-card id="resultTable">
      <div slot="header" class="clearfix">
        <el-row type="flex" justify="space-between">
          ...
          <el-col :span="2" class="no-print"><el-button type="warning" icon="el-icon-printer" plain class="ext-button" @click="$emit('print', {title: '企业工商数据查询'})">打印</el-button></el-col>
        </el-row>
      </div>
      <table class="table card-text">
        ...
        <tr v-if="resultArr.data">
          <td colspan="2">
            <table class="table card-text">
              <tr class="text-left">
                <td colspan="2"><el-tag>基本信息</el-tag></td>
              </tr>
         ...
         <tr v-if="resultArr.shareholder!=[]">
          <td colspan="2">
            <table class="table card-text">
              <tr class="text-left">
                <td colspan="2"><el-tag>股东信息</el-tag></td>
              </tr>
         ...
         <tr v-if="resultArr.shareholderPersons!=[]">
          <td colspan="2">
            <table class="table card-text">
              <tr class="text-left">
                <td colspan="2"><el-tag>高管信息</el-tag></td>
              </tr>
        ...
        <tr v-if="resultArr.legalPersonInvests!=[]">
          <td colspan="2">
            <table class="table card-text">
              <tr class="text-left">
                <td colspan="2"><el-tag>法人对外投资信息</el-tag></td>
              </tr>
        ...
        <tr v-if="resultArr.legalPersonPostions!=[]">
          <td colspan="2">
            <table class="table card-text">
              <tr class="text-left">
                <td colspan="2"><el-tag>法人其他任职信息</el-tag></td>
              </tr>
        ...
        <tr v-if="resultArr.enterpriseInvests!=[]">
          <td colspan="2">
            <table class="table card-text">
              <tr class="text-left">
                <td colspan="2"><el-tag>企业对外投资信息</el-tag></td>
              </tr>
        ...
        <tr v-if="resultArr.alterInfos!=[]">
          <td colspan="2">
            <table class="table card-text">
              <tr class="text-left">
                <td colspan="2"><el-tag>变更信息</el-tag></td>
              </tr>
        ...
        <tr v-if="resultArr.filiations!=[]">
          <td colspan="2">
            <table class="table card-text">
              <tr class="text-left">
                <td colspan="2"><el-tag>分支机构信息</el-tag></td>
              </tr>
         ...
         <tr v-if="resultArr.morguaInfos!=[]">
          <td colspan="2">
            <table class="table card-text">
              <tr class="text-left">
                <td colspan="2"><el-tag>动产抵押物信息</el-tag></td>
              </tr>
        ...
        <tr v-if="resultArr.punished!=[]">
          ...
          <td colspan="2">
            <table class="table card-text">
              <tr class="text-left">
                <td colspan="2"><el-tag>股权冻结历史信息</el-tag></td>
              </tr>
        ...
        <tr v-if="resultArr.liquidations!=[]">
          <td colspan="2">
            <table class="table card-text">
              <tr class="text-left">
                <td colspan="2"><el-tag>清算信息</el-tag></td>
              </tr>
        ...
        <tr v-if="resultArr.mortgageAlter!=[]">
          <td colspan="2">
            <table class="table card-text">
              <tr class="text-left">
                <td colspan="2"><el-tag>动产抵押-变更信息</el-tag></td>
              </tr>
        ...
        <tr v-if="resultArr.mortgageCancels!=[]">
          <td colspan="2">
            <table class="table card-text">
              <tr class="text-left">
                <td colspan="2"><el-tag>动产抵押-注销信息</el-tag></td>
              </tr>
        ...
        <tr v-if="resultArr.mortgageDebtors!=[]">
          <td colspan="2">
            <table class="table card-text">
              <tr class="text-left">
                <td colspan="2"><el-tag>动产抵押-被担保主债权信息</el-tag></td>
              </tr>
         ...
         <tr v-if="resultArr.mortgagePersons!=[]">
          <td colspan="2">
            <table class="table card-text">
              <tr class="text-left">
                <td colspan="2"><el-tag>动产抵押-抵押权人信息</el-tag></td>
              </tr>
        ...
        <tr v-if="resultArr.mortgageRegisters!=[]">
          <td colspan="2">
            <table class="table card-text">
              <tr class="text-left">
                <td colspan="2"><el-tag>动产抵押-登记信息节</el-tag></td>
              </tr>
        ...
        <tr v-if="resultArr.breakLaw!=[]">
          <td colspan="2">
            <table class="table card-text">
              <tr class="text-left">
                <td colspan="2"><el-tag>严重违法信息</el-tag></td>
              </tr>
        ...
        <tr v-if="resultArr.exceptionLists!=[]">
          <td colspan="2">
            <table class="table card-text">
              <tr class="text-left">
                <td colspan="2"><el-tag>企业异常名录</el-tag></td>
              </tr>
       ...
       <tr v-if="resultArr.orgBasics!=[]">
          <td colspan="2">
            <table class="table card-text">
              <tr class="text-left">
                <td colspan="2"><el-tag>组织机构代码</el-tag></td>
              </tr>
        ...
        <tr v-if="resultArr.orgDetails!=[]">
          <td colspan="2">
            <table class="table card-text">
              <tr class="text-left">
                <td colspan="2"><el-tag>股权出质信息详细</el-tag></td>
              </tr>
        ...
        <tr v-if="resultArr.equityInfos!=[]">
          <td colspan="2">
            <table class="table card-text">
              <tr class="text-left">
                <td colspan="2"><el-tag>股权出质信息</el-tag></td>
              </tr>
        ...
        <tr v-if="resultArr.equityChangeInfos!=[]">
          <td colspan="2">
            <table class="table card-text">
              <tr class="text-left">
                <td colspan="2"><el-tag>股权出质信息-变更信息</el-tag></td>
              </tr>
          ...
          <td colspan="2">
            <table class="table card-text">
              <tr class="text-left">
                <td colspan="2"><el-tag>股权出质信息-注销信息</el-tag></td>
              </tr>
         ...
         <tr v-if="resultArr.tradeMarks!=[]">
          <td colspan="2">
            <table class="table card-text">
              <tr class="text-left">
                <td colspan="2"><el-tag>注册商标</el-tag></td>
              </tr>
