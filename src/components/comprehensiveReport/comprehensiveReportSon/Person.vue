        ...
        <el-row>
          <el-col :span="20" v-if="sons.includes('sons1')">
            <el-form-item label-width="0" prop="sourcet" class="form-item">
              ...
              <el-checkbox v-model="selectAll.sourcetArr1" class="select-all" name="selectAll" :indeterminate="isIndeterminate.sourcetArr1"
                @change="handleCheckAllChange('sourcetArr1')">全选</el-checkbox>
        ...
        <el-row>
          <el-col :span="20" v-if="sons.includes('sons2')">
            <el-form-item label-width="0" prop="sourcet" class="form-item">
              ...
              <el-checkbox v-model="selectAll.sourcetArr2" class="select-all" name="selectAll" :indeterminate="isIndeterminate.sourcetArr2"
                @change="handleCheckAllChange('sourcetArr2')">全选</el-checkbox>
        ...
        <el-row>
          <el-col :span="20" v-if="sons.includes('sons3')">
            <el-form-item label-width="0" prop="sourcet" class="form-item">
              ...
              <el-checkbox v-model="selectAll.sourcetArr3" class="select-all" :indeterminate="isIndeterminate.sourcetArr3"
                @change="handleCheckAllChange('sourcetArr3')" name="selectAll">全选</el-checkbox>
        ...
        <el-row>
          <el-col :span="20" v-if="sons.includes('sons4')">
            <el-form-item label-width="0" prop="sourcet" class="form-item">
              ...
              <el-checkbox v-model="selectAll.sourcetArr4" class="select-all" :indeterminate="isIndeterminate.sourcetArr4"
                @change="handleCheckAllChange('sourcetArr4')" name="selectAll">全选</el-checkbox>
      ...
      <div slot="header" class="clearfix">
        <el-row type="flex" justify="space-between">
          ...
          <el-col :span="2" class="no-print">
            <el-button type="warning" icon="el-icon-printer" plain class="ext-button" @click="$emit('print', {title: '多重借贷查询'})">打印</el-button>
          </el-col>
        </el-row>
      </div>
            ...
            <table class="table card-text">
              ...
              <table class="table card-text">
                ...
                <tr class="text-left">
                  <td width="20%">匹配结果</td>
                  <td>
                    <el-tag :type="resultData.sourcetArr1[0].success | isSuccessLogoFmt" class="tag">{{resultData.sourcetArr1[0].success
              ...
              <table class="table card-text">
                ...
                <tr class="text-left">
                  <td width="20%">匹配结果</td>
                  <td>
                    <el-tag :type="resultSuccess.logo" class="tag">{{resultSuccess.name}}</el-tag>
                  </td>
                </tr>
                <tr class="text-left">
                  <td>姓名</td>
