  ...
  <div id="Enterprise">
    ...
    <el-card id="resultTable">
      ...
      <table class="table card-text">
        ...
        <table class="table card-text" v-for="ret in result.retData" :key="ret.entName" v-if="urlPd.exe2">
          <tr class="text-left">
        ...
        <table class="table card-text" v-if="urlPd.exe5">
          <tr class="text-left">
            <td colspan="4">
        ...
        <table class="table card-text" v-if="urlPd.exe6">
          <tr class="text-left">
            <td colspan="4">
  ...
  export default {
    ...
    methods: {
      ...
      handleCheckAllChange (val) {
        this.sons = val ? this.setArray.map(v => { return v.label; }) : [];
            ...
            vm.$http
              ...
              .then(function (res) {
                if (res.data.success) {
                  ...
                  vm.result.retData4.idCard = res.data.data.identityCard;
                  vm.result.retData4.result = res.data.data.pageData;
                  vm.result.retData4.statistic = res.data.data.statistic;
        ...
        vm.$refs["inputForm"].validate(valid => {
          if (valid) {
            ...
            vm.$http
              ...
              .then(function (res) {
                if (res.data.success) {
                  vm.result.regDate5.name = res.data.data.name;
                  vm.result.regDate5.idCard = res.data.data.identityCard;
                  vm.result.regDate5.result = res.data.data.pageData;
                } else {
                  vm.$message({
                    showClose: true,
                    message: res.data.errorDesc,
